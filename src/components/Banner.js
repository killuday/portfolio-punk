...
import Image from "../assets/Uday.webp";
        ...
        <div className="flex flex-col gap-y-8  lg:flex-row lg:items-center lg:gap-x-12 ">
          <div className="flex-1 text-center font-secondary lg:text-left ">
            ...
            <motion.div  variants={fadeIn('up', 0.3)}
              ...
              <TypeAnimation
                sequence={["Developer", 2000, "Designer", 2000, "Gamer", 2000]}
                speed={50}
            ...
            <motion.p variants={fadeIn('up', 0.5)}
              ...
              "Rebel coder, fearless designer, disrupting norms with badass
              creations!"
            </motion.p>
            <motion.div variants={fadeIn('up', 0.6)}
              initial='hidden'
              whileInView={'show'}
              viewport={{ once: false, amount: 0.7 }} className="flex items-center gap-x-6 mb-12 max-w-max mx-auto lg:mx-0">
          ...
          <motion.div variants={fadeIn('down', 0.5)}
            ...
            <img
              className="rounded-full w-[400px] h-[500px] "
              src={Image}
              alt=""
            />
          </motion.div>
